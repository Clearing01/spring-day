				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							<li><a href="login.do?lang=zh">汉语</a></li>
							<li><a href="login.do?lang=ja">日本語</a></li>
						</ul>
					</nav>
									...
									<div class="content">
										...
										<table class="alt">
												<tbody>
													...
													<tr>
														<td colspan="3" align="right"><input type="submit" class="button primary" value="<spring:message code="message.introduction.login" />"> <a href="signin.jsp" class="button primary"><spring:message code="message.introduction.sign" /></a> </td>
													</tr>
												</tbody>
										</table>
										</form>
