									...
									<div class="content">
										...
										<table class="alt">
												<tbody>
													<tr>
														<td>ID</td>
														<td colspan="2"><input type="text" name="mid" value="${member.mid}" required></td>
													</tr>
													<tr>
														<td>PASSWORD</td>
														<td colspan="2"><input type="password" name="mpw" value="${member.mpw}"></td>
													</tr>
													<tr>
														<td>NAME</td>
										...
										<a href="deleteMember.do" style="float:right">회원탈퇴</a>
